        ...
        >
          ...
          <Grid className={classes.cont2}>
            <Typography variant="h5" className={classes.text}>
              Este tipo de personalidad manifiesta interés por la comprensión de
              relaciones, el pensamiento lógico, poseen facilidad para los
              cálculos, capacidad de liderazgo y supervisión. Son personas
              metódicas, analíticas, observadoras, introvertidas, pacientes,
              ...
              <List>
                <ListItem>
                  ...
                  <ListItemText
                    primary={
                      <Typography variant="h5" className={classes.text}>
                        Educación comercial y administración: comercio al por
                        menor, comercialización, ventas, relaciones públicas,
                  ...
                  <ListItemText
                    primary={
                      <Typography variant="h5" className={classes.text}>
                        ...
                        Internacionales, Comercialización, Marketing.
                      </Typography>
                    }
                  />
                </ListItem>
